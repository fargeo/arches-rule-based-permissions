module.exports = {
    input: {
        path: "./arches_rule_based_permissions/src", // only files in this directory are considered for extraction
    ...
    output: {
        path: "./arches_rule_based_permissions/locale", // output path of all created files
